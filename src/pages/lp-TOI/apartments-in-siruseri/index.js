...
import twojLogo from "../../../../public/images/logo.png";

import trishaImg from "../../../../public/images/formBanner.jpg";
...
function Contact() {
  return (
    ...
    >
      ...
      >
        <Button
          onClick={() => window.open("tel:+91 8586923040")}
          sx={{
            width: "95%",
      ...
      >
        ...
        >
          ...
          <Grid
            ...
            item
            xs={12}
            sx={{ marginTop: { xs: "2rem", md: "0px" }, gap: "5px" }}
          >
            <Typography
              component="p"
              sx={{
            ...
            >
              Welcome To Urbanrise The World Of Joy
            </Typography>
            <Typography
              component="h3"
              sx={{
        ...
        >
          <Image src={trishaImg} style={{ width: "100%", height: "100%" }} />
        </Grid>
        <Grid
          container
          item
